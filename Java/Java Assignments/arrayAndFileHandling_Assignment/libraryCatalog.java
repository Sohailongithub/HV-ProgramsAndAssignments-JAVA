...
public class libraryCatalog {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-------------------------------------------------------------");
        System.out.println("               Welcome to Unique Library                     ");
        ...
        System.out.println("-------------------------------------------------------------");
        System.out.println("Press 1 to Display The List Of All Books ");
    ...
    private static void initializeCatalog() {
        catalog[0] = new String[] {"101", "HTML and CSS", "Jon Cuckett", "Avaiable", "Null"};
    ...
    private static void returnBook(Scanner scanner) {
        ...
        int daysDelayed = calculateDaysDelayed(book[4], bookID);
    ...
    private static int calculateDaysDelayed(String string, String issueDate) {
        try {
